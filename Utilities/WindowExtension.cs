...
namespace Hani.Utilities
{
    internal static class WindowExtension
    {
        ...
        internal static void FlashWindow(this Window win, UInt32 count = UInt32.MaxValue)
        {
            ...
            SafeNativeMethods.FlashWindowEx(ref info);
        }

        /*internal static void StopFlashingWindow(this Window win)
        {
            WindowInteropHelper h = new WindowInteropHelper(win);
